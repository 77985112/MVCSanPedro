...
$celebrantes = $controller->mostrarDatosPorSacramento($Sacramento);
...
<body class="sidebar-start-enabled">
    <header class="navbar-light fixed-top header-static bg-mode">
        <nav class="navbar navbar-expand-lg">
            ...
            <a class="btn btn-outline-secondary py-0 me-3" href="javascript:history.back()"><i class="bi bi-arrow-left fs-5 lh-0"></i></a>
            <div class="container">
        ...
        <div class="container-fluid">
            <div class="row justify-content-between g-0">
                ...
                <section class="pt-0 ">
                    <div class="container">
                        <div class="card">
                            <h2 class="align-items-center text-center" style="margin-top: 5%;">Estado Actual de <?php echo $Sacramento; ?></h2>

                            <div class="row" style="margin-left: 5%; margin-right: 5%; margin-top: 5%;">

                                <?php $numGrupo = 0; foreach ($celebrantes as $grupo): ?>
                                    <div class="col-12 col-md-3">
                                        <div class="card mb-3">
                                            <div class="card-body pt-0 border border-white border-3 rounded text-center">
                                                <input type="hidden" value="<?php echo $grupo['IdGrupo']; ?>">
                                                <h5 class="mb-0">
                                                    <a href="GrupoEsp.php?id=<?php echo $grupo['IdGrupo']; ?>">
                                                        Grupo: <?php echo str_pad($numGrupo, 2, '0', STR_PAD_LEFT); ?>
                                                    </a>
                                                </h5>
                                                <div class="hstack gap-2 gap-xl-3 justify-content-center">
                                                    <div>
                                                        <h6 class="mb-0"><?php echo $grupo['totalInscripciones']; ?></h6>
                                                        <small>Catequisando</small>
                                                    </div>
                                                    <div class="vr"></div>
                                                    <div>
                                                        <h6 class="mb-0"><?php echo $grupo['totalAsignaciones']; ?></h6>
                                                        <small>Catequista</small>
                                                    </div>
                                                </div>
                                                <div class="loader" style="--loader-color: <?php echo $grupo['Color_Grupo'] !== 'Ninguno' ? $grupo['Color_Grupo'] : '#000'; ?>;"></div>
                                            </div>
                                        </div>
                                    </div>
                                <?php $numGrupo++; endforeach; ?>
