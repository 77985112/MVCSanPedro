...
if (isset($_GET['id'])) {
    $idGrupo = $_GET['id'];
    $datosGrupo = $contG->mostrarGrupoCoor($idGrupo);

    if ($datosGrupo) {
        $grupo = $datosGrupo['grupo'];
        $catGrupo = $datosGrupo['catequistas'];
            ...
            <div class="row justify-content-between g-0">
                ...
                <div class="col-md-2 col-lg-3 col-xxl-4 mt-n4">
                    <div class="nav-sidenav p-4 bg-mode h-100 custom-scrollbar">
                        <ul class="nav nav-link-secondary flex-column fw-bold gap-2">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="VistaCoordinador.php"> <i class="bi bi-house nav-icon"></i> <span class="nav-text">Inicio </span></a>
                            </li>
                            <li class="nav-item">
                ...
                <section class="pt-0 ">
                    <div class="container">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Información del <strong>Grupo <?php echo $grupo['NombreGrupo']; ?></strong></h4>
                                ...
                                <form action="GrupoEsp.php?id=<?php echo $grupo['IdGrupo']; ?>" method="POST" enctype="multipart/form-data">
                                            ...
                                            <ul class="list-group">
                                                <li class="list-group-item d-md-flex justify-content-between align-items-center">
                                                    <div class="me-md-3">
                                                        ...
                                                        <img id="imagenPreviewFondo" class="h-200px rounded" src="<?php echo ($grupo['Imagen_Grupo'] == 'Anonimo' || empty($grupo['Imagen_Grupo'])) ? '../assets/images/Santo/SanPedro.png' : "../assets/images/Santo/{$grupo['Imagen_Grupo']}"; ?>" alt="" style="background-size: cover; background-repeat: no-repeat; width: 180px;">
                                    ...
                                    <div class="col-lg-12 d-flex p-4">
                                        <div class="col-sm-6 col-lg-6">
                                            <button type="submit" class="btn btn-primary-soft mb-0 me-2">Actualizar datos de Grupo</button>
                                        </div>
                                        <div class="col-sm-6 col-lg-6">
                                            <a href="ListadeGrupo.php?Gr=<?php echo $grupo['IdGrupo']; ?>&N=<?php echo $grupo['NombreGrupo']; ?>" class="btn btn-primary-soft mb-0 me-2" target="_blank">Generar Lista de integrantes</a>
                                        </div>
                                    </div>
                                </form>

                                <div class="card-body col-lg-6">
                                    <h3 class="mb-0">Catequistas</h3>
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <?php $i=0; foreach ($catGrupo as $catG): $i++; ?>
                                                <tr>
                                                    <td><?php echo $i; ?></td>
                                                    <td><?php echo $catG['CiCat']; ?></td>
                                                    <td><?php echo $catG['NombreCompleto']; ?></td>
                                                    <td><?php echo $catG['Rol']; ?></td>
                                                    <td><?php echo $catG['Estado']; ?></td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
                                    </table>
                                ...
                                <div class="card-body col-lg-10">
                                    <h3 class="mb-0">Catequisandos</h3>
                                    <table class="table">
                                        <thead class="table-dark">
                                            <tr>
                                                <th>Nº</th>
                                        ...
                                        <tbody>
                                            <?php $i=0; foreach ($celGrupo as $celG): $i++; ?>
                                                <tr>
                                                    <td><?php echo $i; ?></td>
