...
$catequistasCoor = $contCats->CatequsitasSacCoor($Catequista['Sacramento']);
        ...
        <div class="container-fluid">
            <div class="row justify-content-between g-0">
                ...
                <div class="col-md-2 col-lg-3 col-xxl-4 mt-n4">
                    <div class="nav-sidenav p-4 bg-mode h-100 custom-scrollbar">
                        <ul class="nav nav-link-secondary flex-column fw-bold gap-2">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="VistaTodosCat.php"> <i class="bi bi-file-earmark-text nav-icon"></i> <span class="nav-text">Reporte </span></a>
                            </li>
                ...
                <section class="pt-0 ">
                    <div class="container">
                        <div class="card p-4">
                            <h2 class="align-items-center text-center" style="margin-top: 5%;">Listado de Catequistas</h2>
                            <?php if ($Catequista['RolCat'] == "Coordinador") { ?>
                                <div class="col-lg-12 align-items-center d-flex py-2">
                                    <div class="col-sm-6 col-lg-6 me-2">
                                        <a href="VistaCatsActivo.php" class="btn btn-success-soft w-100" target="_blank"><i class="bi bi-file-earmark-text"></i>Reporte de Catequistas Activos</a>
                                    </div>
                                    <div class="col-sm-6 col-lg-6">
                                        <a href="VistaCatsInactivo.php" class="btn btn-primary-soft w-100" target="_blank">Reporte de Catequistas Inactivos <i class="bi bi-file-earmark-text"></i></a>
                                    </div>
                                </div>
                            <?php } ?>
                            <div class="row">
                                <?php if (!empty($catequistasCoor)) : ?>
                                    <?php foreach ($catequistasCoor as $cates) : ?>
                                        <div class="col-lg-3 col-md-4 col-sm-6 mb-4 catequista-card">
                                            <div class="card shadow-none text-center">
                                                <div class="card-body p-1 pb-0">
                                                    ...
                                                    <p class="mb-1 mt-3"><strong><?php echo $cates['NombreCompleto']; ?></strong></p>
                                                    <div class="hstack gap-2 gap-xl-3 justify-content-center">
                                                        <div>
                                                            <h6 class="mb-0"><?php echo $cates['RolCat']; ?></h6>
                                                            <small>Cargo</small>
                                                        </div>
                                                        <div class="vr"></div>
                                                        <div>
                                                            <h6 class="mb-0"><?php echo $cates['NombreGrupo']; ?></h6>
                                                            <small>Grupo</small>
                                                        </div>
                                                        <div class="vr"></div>
                                                        <div>
                                                            <h6 class="mb-0"><?php echo $cates['EstadoCat']; ?></h6>
                                                            <small>Estado</small>
                                                        </div>
                                                    </div>
                                                </div>
