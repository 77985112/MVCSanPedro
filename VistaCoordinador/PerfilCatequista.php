                                                ...
                                                <div class="col-6">
                                                    <div class="card shadow-none text-center h-100">
                                                        <div class="card-body p-2 pb-0">
                                                            ...
                                                            <h6 class="card-title mb-1 mt-3"> <?php echo $catequistaCoor['NombreCompleto']; ?></h6>
                                                            <p class="mb-0 small lh-sm"><?php echo $catequistaCoor['RolCat']; ?></p>
                                                        </div>
