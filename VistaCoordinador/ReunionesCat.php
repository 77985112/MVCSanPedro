...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['registrarReu'])) {
    if ($contReu->RegistrarReu($_POST)) {
        header("Location: " . $_SERVER['PHP_SELF']);
        exit();
    } else {
        echo "<div class='alert alert-danger'>Error al agregar reunión.</div>";
    }
}
...
<body class="sidebar-start-enabled">
                ...
                <section class="pt-0 ">
                    <div class="container">
                        <div class="card">
                            ...
                            <h3 class="align-items-center text-center" style="margin-top: 5%;">Detalle de reuniones en "<?php echo $Catequista['Sacramento']; ?>"</h3>

                            <div class="mx-auto bg-mode shadow rounded p-4 mt-5">
                                <div class="text-center">
                                    <h5>Registrar fecha de próximas reuniones</h5>
                                </div>
                                <form class="row g-4" method="post">
                                    ...
                                    <div class="col-sm-8 col-lg-7">
                                        <label class="form-label">Detalle de Reunión</label>
                                        <input type="text" class="form-control" name="Detalle" placeholder="De que se hablará en la reunión" required>
                                    </div>

                                    <div class="col-sm-8 col-lg-3">
                                        <label class="form-label">Fecha de Reunión</label>
                                        <input type="date" class="form-control" name="FechaR" id="fechaR" required>
                                    </div>

                                    <div class="col-sm-8 col-lg-2">
                                        <label class="form-label">Hora de Reunión</label>
                                        <input type="time" class="form-control" name="HoraR" id="horaR" required>
                                    </div>

                                    <div class="col-sm-12 col-lg-12">
                                        <button class="btn btn-primary-soft w-100" type="submit" name="registrarReu">Agregar Fecha de Próxima Reunión</button>
                                    </div>
                                </form>
                            </div>
                            ...
                            <div class="p-4">
                                <h3 class="align-items-center text-center">Detalle de próximas reuniones registradas</h3>
    ...
    <script>
        ...
        const horaInput = document.getElementById('horaR');
