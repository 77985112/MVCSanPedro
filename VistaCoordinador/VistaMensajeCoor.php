...
$controller = new ControladorMensaje();
$mensajes = null;

$mensajes = $controller->listarMensajes();


if (isset($_GET['action']) && $_GET['action'] == 'leer' && isset($_GET['id'])) {
    $controller->leerMensaje($_GET['id']);
    $mensajes = $controller->listarMensajes();
}
...
<body class="sidebar-start-enabled">
    <header class="navbar-light fixed-top header-static bg-mode">
        <nav class="navbar navbar-expand-lg">
            <button class="btn text-secondary py-0 me-3 sidebar-start-toggle"><i
                    class="bi bi-justify-left fs-3 lh-0"></i></button>
            <div class="container">
                ...
                <ul class="nav flex-nowrap align-items-center ms-sm-3 list-unstyled">
                    <li class="nav-item ms-2">
                        <a class="nav-link bg-light icon-md btn btn-light p-0" href="Configuracion.php"
                            data-bs-toggle="tooltip" data-bs-placement="bottom" title="Configurar">
                    ...
                    <li class="nav-item ms-2 dropdown">
                        <a class="nav-link btn icon-md p-0" href="#" id="profileDropdown" role="button"
                            ...
                            <img class="avatar-img rounded border border-white border-3"
                                src="<?php echo ($Catequista['ImagenCat'] == 'Ninguno' || empty($Catequista['ImagenCat'])) ? '../assets/images/avatar/Ninguno.png' : "../assets/images/avatar/{$Catequista['ImagenCat']}"; ?>"
                                alt="">
                        </a>
                                ...
                                <div class="d-flex align-items-center position-relative">
                                    ...
                                    <div>
                                        <a class="h6 stretched-link"
                                            href="#"><?php echo $Catequista['Nombre'] . " " . $Catequista['ApPaterno'] . " " . $Catequista['ApMaterno']; ?></a>
                                        <p class="small m-0"><?php echo $Catequista['RolCat']; ?> <i
                                                class="bi bi-patch-check-fill text-success small"></i></p>
                                    </div>
                                </div>
                                <a class="dropdown-item btn btn-primary-soft btn-sm my-2 text-center"
                                    href="PerfilCatequista.php">Ver mi Perfil</a>
                            </li>
                            <hr>
                            <li>
                                <a class="dropdown-item" href="Configuracion.php"><i
                                        class="bi bi-gear fa-fw me-2"></i>Configuración y Privacidad</a>
                            </li>
                            <li>
                                <a class="dropdown-item" href="ReunionesCat.php"><i
                                        class="fa-fw bi bi-calendar2-check me-2"></i>Fecha de Reuniones</a>
                            </li>
                            <li>
        ...
        <div class="container-fluid">
            <div class="row justify-content-between g-0">
                ...
                <div class="col-md-2 col-lg-3 col-xxl-4 mt-n4">
                    <div class="nav-sidenav p-4 bg-mode h-100 custom-scrollbar">
                        <ul class="nav nav-link-secondary flex-column fw-bold gap-2">
                            <h6
                                class="nav-text badge bg-primary text-white mt-2 me-2 border border-white border-3 rounded">
                                <i class="bi bi-caret-down-fill"></i>&nbsp;&nbsp; General
                            </h6>
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="VistaMensajeCoor.php"> <i class="bi bi-file-earmark-text nav-icon"></i> <span class="nav-text">Mensaje Público</span></a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <section class="pt-0 ">
                    <div class="container">
                        <div class="card p-3">
                            <h4>Detalle de Mensaje Publicos</h1>
                                ...
                                <div class="card-body p-5">
                                    <ul class="list-unstyled">
                                        ...
                                        <li>
                                            <input type="hidden" value="<?php echo $fila['FechaMensaje']; ?>"></input>
                                            <div class="rounded b-1  <?php if ($fila['EstadoMensaje'] == 'Pendiente') { echo 'badge-unread';} ?> d-sm-flex border-0 mb-1 p-3 position-relative">
                                                <div class="mx-sm-3 my-2 my-sm-0">
                                                    <p class="small mb-0"><b><?php echo $fila['ConceptoMensaje']; ?></b>
                                                    </p>
                                                    <p class="small mb-0"><?php echo $fila['DetalleMensaje']; ?></p>
                                                    <p class="small mb-0">
                                                        <strong><i class="bi bi-person-fill"></i> <?php echo $fila['NombreMensaje']; ?></strong> - <i class="bi bi-whatsapp"></i> <a href="https://wa.me/591<?php echo $fila['NumCorrMensaje']; ?>"><?php echo $fila['NumCorrMensaje']; ?></a>
                                                    </p>

                                                </div>
                                                <div class="d-flex ms-auto">
                                                    <p class="small me-5 text-nowrap">Justo Ahora</p>
                                                    <?php if ($fila['EstadoMensaje'] == 'Pendiente') { ?>
                                                    <a href="VistaMensajeCoor.php?action=leer&id=<?php echo $fila['idMensaje']; ?>">
                                                        <i class="bi bi-check-square"></i></a>
                                                    <?php } else { ?>
                                                    <span><strong><i class="bi bi-check2-all"></i></strong></span>
                                                    <?php } ?>
                                                </div>
                                            </div>
                                        </li>
                        ...
                        <div class="sidebar-end-alignment d-flex justify-content-center flex-column">
                            ...
                            <ul class="list-unstyled">
                                ...
                                <li class="mt-2 hstack gap-3 align-items-center position-relative">
                                    <input type="hidden"
                                        value="<?php echo htmlspecialchars($catequistaCoor['CiCat']); ?>">
                                    <div class="avatar avatar-xs">
                                        <img class="avatar-img rounded-circle"
                                            src="<?php echo ($catequistaCoor['ImagenCat'] == 'Ninguno' || empty($catequistaCoor['ImagenCat'])) ? '../assets/images/avatar/Ninguno.png' : "../assets/images/avatar/{$catequistaCoor['ImagenCat']}"; ?>"
                                            alt="">
                                    </div>
                                ...
                                <?php endforeach; ?>
                                <?php else: ?>
                                <p class="p-3">No hay catequistas disponibles.</p>
                                <?php endif; ?>
                            </ul>
                            ...
                            <ul class="list-unstyled pb-5">
                                ...
                                <li class="mt-3 hstack gap-3 align-items-center position-relative">
                                    <div class="flex-shrink-0 avatar">
                                        <ul class="avatar-group avatar-group-four">
                                            ...
                                            <li class="avatar avatar-xxs">
                                                <img class="avatar-img rounded-circle"
                                                    src="<?php echo ($catSac['ImagenCat'] == 'Ninguno' || empty($catSac['ImagenCat'])) ? '../assets/images/avatar/Ninguno.png' : "../assets/images/avatar/{$catSac['ImagenCat']}"; ?>"
                                                    alt="avatar">
                                            </li>
                                            <?php endforeach; ?>
                                            <?php else: ?>
                                    ...
                                    <div class="overflow-hidden contact-name">
                                        <a class="h6 mb-0 stretched-link text-truncate d-inline-block" href="VistaTodosCat.php">Ver
                                            todos</a>
                                    </div>
                                </li>
