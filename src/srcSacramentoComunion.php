                    ...
                    <ul class="navbar-nav navbar-nav-scroll me-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="SacramentoMenu">
                                ...
                                <li> <a class="dropdown-item active" href="srcSacramentoComunion.php">Primera Comunión</a></li>
                            ...
                            <section class="p-4 p-sm-5">
                                        ...
                                        <div class="col-lg-10 ms-auto">
                                            <div class="row g-4 align-items-center">
                                                <div class="col-md-4 col-lg-4 position-relative">
                                                    ...
                                                    <img class="rounded-circle" src="../assets/images/post/Sacramentos/comunion.jpg" alt="" style="width: 350px; height: 300px;">

                                                </div>
                                                <div class="col-md-8 col-lg-8 ">
                                                    <div class="ms-4">
                                                        <h2 class="h2">¿Qué es la Primera Comunión?</h2>
                                                        <p>La Primera Comunión es la celebración de la Iglesia Católica donde el niño y la niña participan por primera vez en el Sacramento de la Eucaristía, recibiendo la Comunión. </p>
                                                        <p>La Sagrada Comunión es la presencia de Jesucristo en la Eucaristía, donde le recibimos sacramentado bajo las especies del pan y del vino.
                                                            <strong>"Yo soy el pan vivo, bajado del cielo. Si uno come de este pan, vivirá para siempre, y el pan que yo le voy a dar es mi carne por la vida del mundo".</strong> (Jn 6, 51)
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-lg-12 text-center mb-2">
                                        <h2 class="h2">Requisitos para Primera Comunión</h2>
                                        <p>Todo lo que necesitas para realizar la Primera Comunión.</p>
                                    </div>
                                </div>

                                <div class="col-lg-12">
                                    <div class="ms-2">
                                        <h6 class="h6"><i class="bi bi-arrow-return-right"></i> De los Niños(as):</h6>
                                        <p>&nbsp;&nbsp;&nbsp;<i class="bi bi-caret-right-fill"></i> Certificado de Nacimineto.</p>
                                        <p>&nbsp;&nbsp;&nbsp;<i class="bi bi-caret-right-fill"></i> Certificado de Bautizo.</p>
                                        <p><strong>NO</strong> es indispensable tener padrinos, en caso de solcitarlos, estos no deben vivir en concubinato, estar casados por lo civil, divorciados ó los que no hicieron el sacramento de Confirmación.</p>
                                    </div>
                                </div>
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-lg-12 text-center mb-2">
                                        <h4 class="h4">Cuando se realiza la Primera Comunión</h4>
                                    </div>
                                </div>
                                            ...
                                            <?php if (count($sacramentos) > 0): ?>
                                                <?php foreach ($sacramentos as $row): ?>
                                                    ...
                                                    <?php if ($row['ActividadSac'] == 'Inscripción'): ?>
                                                        <h6 class="h6"><i class="bi bi-arrow-return-right"></i> <i class="bi bi-backpack-fill"></i> Fecha de <strong>inscripción a Primera Comunión:</strong></h6>
                                                        ...
                                                        <!-- Mostrar el mensaje de estado según la fecha -->
                                                        <p id="inscripcion<?php echo $row['idSacramento']; ?>" class="text-center"></p>

                                                    <?php elseif ($row['ActividadSac'] == 'Comunión'): ?>
                                                        <h6 class="h6"><i class="bi bi-arrow-return-right"></i> <i class="bi bi-backpack-fill"></i> Fecha de <strong>celebración de Primera Comunión:</strong></h6>
                                                        <p>&nbsp;&nbsp;&nbsp;<i class="bi bi-align-end"></i> <strong>Fecha: </strong> <?php echo "$diaSemanaIni, $diaIni de $mesIni"; ?> <strong> - a - </strong><?php echo "$diaSemanaFin, $diaFin de $mesFin"; ?></p>
                                                        <p>&nbsp;&nbsp;&nbsp;<i class="bi bi-clock"></i> Hora: <?php echo htmlspecialchars(date('H:i', $fechaIni)); ?> a <?php echo htmlspecialchars(date('H:i', $fechaFin)); ?></p>
                                                ...
                                                <script>
                                                    // Función para actualizar el estado según la fecha actual
                                                    ...
                                                    // Aplicar las funciones a cada sacramento
                                                    <?php foreach ($sacramentos as $row): ?>
                                                        actualizarEstado(
