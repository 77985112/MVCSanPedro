...
$catequistasCom = $controller->mostrarCatCom();
?>
                    ...
                    <ul class="navbar-nav navbar-nav-scroll me-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="NosotrosMenu">
                                ...
                                <li> <a class="dropdown-item active" href="srcNosotrosComunion.php">Primera Comunión</a></li>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-12 text-center mb-4">
                        <h2 class="h1">Nuestros Catequistas de 'Primera Comunión'</h2>
                        <p class="card-title mb-0">Conoce a nuestros Catequistas de Primera Comunión (Grupo y Cargo)</p>
                    </div>
                </div>
                <br>
