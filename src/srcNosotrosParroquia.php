...
$personalParr = $controller->getPersonal();
?>
                    ...
                    <ul class="navbar-nav navbar-nav-scroll me-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="NosotrosMenu">
                                <li> <a class="dropdown-item active" href="srcNosotrosParroquia.php">Parroquia</a></li>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-12 text-center mb-4">
                        <h2 class="h1">Todo nuestro personal a cargo de la Parroquia</h2>
                        <p class="card-title mb-0">Conoce a nuestro Personal que está a cargo de administrar los sacramentos.</p>
                    </div>
                </div>
                <br>
                ...
                <div class="container">
                    <div class="row">
                        <?php if (!empty($personalParr)) : ?>
                            <?php foreach ($personalParr as $catequista) : ?>
                                <div class="col-lg-3 col-md-4 col-sm-6 mb-4 catequista-card">
                                    <div class="card shadow-none text-center">
                                        <div class="card-body p-1 pb-0">
                                            <div class="avatar avatar-xl">
                                                <img class="avatar-img rounded-circle" src="<?php echo ($catequista['PerfilPer'] == 'Ninguno' || empty($catequista['PerfilPer'])) ? '../assets/images/avatar/Ninguno.png' : "../assets/images/avatar/{$catequista['PerfilPer']}"; ?>" alt="">
                                            </div>
                                            <p class="mb-1 mt-3"><strong><?php echo $catequista['NombreCompleto']; ?></strong></p>
                                            <div class="hstack gap-2 gap-xl-3 justify-content-center">
                                                <div>
                                                    <h6 class="mb-0"><?php echo $catequista['DescripCar']; ?></h6>
                                                    <small>Cargo</small>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="card-footer p-2 border-0">
                                            <form action="srcPerfilAjeno.php" method="POST">
                                                <input type="hidden" name="CiPer" value="<?php echo $catequista['CiPersonal']; ?>">
