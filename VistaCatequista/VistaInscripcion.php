...
if (isset($_POST['ciPersona'])) {
    $persona = $controller->buscarPersona($_POST['ciPersona']);
}
                                ...
                                <div class="card overflow-hidden">
                                    ...
                                    <div class="card-body pt-0">
                                        ...
                                        <ul class="nav nav-link-secondary flex-column fw-bold gap-2">
                                            ...
                                            <?php if ($Catequista['RolCat'] == "Titular") { ?>
                                                <li class="nav-item">
                                                    <a class="nav-link" href="VistaDocCel.php"> <img class="me-2 h-20px fa-fw" src="../assets/images/icon/Documentos.png" alt=""><span>Documentos</span></a>
                                                </li>
                                                <li class="nav-item">
                                            ...
                                            <?php if ($Catequista['PoderCat'] == "Habilitado") { ?>
                                                <li class="nav-item">
                                                    <a class="nav-link active" href="VistaInscripcion.php"> <img class="me-2 h-20px fa-fw" src="../assets/images/icon/Inscripcion.png" alt=""><span>Inscripciones</span></a>
                                                </li>
                                            <?php } ?>
                                        </ul>
                                    </div>
                        ...
                        <div class="card-body">
                            ...
                            <?php if (!empty($mensaje)): ?>
                                <div class="alert alert-success" role="alert">
                                    <?php echo $mensaje; ?>
                                    <?php if ($mensaje != "Catequisando modificado con éxito.") { ?>
                                        <a href="tiketCel.php" target="_blank" class="btn btn-xs btn-success mt-2 mt-lg-0 ms-lg-4">Generar ticket</a>
                                    <?php }; ?>
                                </div>
                            <?php endif; ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" class="row g-1">
                        ...
                        <input type="hidden" name="SacramentoCel" value="<?php echo $Catequista['Sacramento']; ?>">

                        <div class="form-group col-lg-5">
                            <label for="CodTipoItem" class="form-label">Sacramento</label>
                            <?php if ($Catequista['Sacramento'] == 'Primera Comunión'): ?>
                                <input type="hidden" class="form-control" name="IdGrupo" value="1">
                            ...
                            <?php elseif ($Catequista['Sacramento'] == 'Confirmación'): ?>
                                <input type="hidden" class="form-control" name="IdGrupo" value="22">
                                <select class="form-control" name="CodTipoItem" data-search-enabled="true">
                    ...
                    success: function(response) {
                        if (response.EstadoCat && response.RolCat) {
                            ...
                            if (response.EstadoCat === "Inactivo") {
                                window.location.replace("PerfilCatequistaequista.php");
                            }
                        } else {
