                                    ...
                                    <div class="card-body pt-0">
                                        ...
                                        <ul class="nav nav-link-secondary flex-column fw-bold gap-2">
                                            ...
                                            <?php if ($Catequista['RolCat'] == "Titular") { ?>
                                                ...
                                                <li class="nav-item">
                                                    <a class="nav-link active" href="VistaReporteGrupo.php"> <img class="me-2 h-20px fa-fw" src="../assets/images/icon/reporte.png" alt=""><span>Reporte General</span></a>
                                                </li>
                                            <?php } ?>
                                        </ul>
                                    </div>
                            ...
                            <div class="py-3">
                                <div class="row position-relative">
                                    <div class="col-lg-11 mx-auto">
                                        <div class="text-center">
                                            <h3>Reporte General de Catequesis (Grupo: <?php echo $Catequista['NombreGrupo']; ?>)</h3>
                                        </div>
                                        <div class="mx-auto bg-mode shadow rounded p-4 mt-5 col-lg-12">
                                            ...
                                            <?php if (count($sacramentos) > 0): ?>
                                                <?php foreach ($sacramentos as $row): ?>
                                                    ...
                                                    <?php if ($row['ActividadSac'] == 'Comunión' || $row['ActividadSac'] == 'Confirmación'): ?>
                                                        ...
                                                        <h6 class="text-center">Observe el tiempo de culminación de <?php echo $Catequista['Sacramento']; ?></h6>
                                                ...
                                                <script>
                                                    ...
                                                    function actualizarCuentaRegresiva(fechaObjetivo, elementoId) {
                                                        ...
                                                        const intervalo = setInterval(function() {
                                                            ...
                                                            document.getElementById(elementoId).innerHTML = `${dias} días, ${horas} horas, ${minutos} minutos, ${segundos} segundos`;
                                        ...
                                        <div class="col-lg-12 align-items-center d-flex py-3">
                                            <div class="col-sm-6 col-lg-6 me-2">
                                                <a href="CelebranteApp.php" class="btn btn-success-soft w-100" target="_blank"><i class="bi bi-file-earmark-text"></i> Reporte de catequisandos que cumplieron</a>
                                            </div>
                                            <div class="col-sm-6 col-lg-6">
                                                <a href="CelebranteInApp.php" class="btn btn-primary-soft w-100" target="_blank">Reporte de catequisandos que incumplieron <i class="bi bi-file-earmark-text"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
