...
$CatCi = $Catequista['CiCat'];
$CatGr = $Catequista['IdGrupo'];
...
if ($_SERVER['REQUEST_METHOD'] === 'GET' && isset($_GET['IpCS']) && !empty($_GET['IpCS'])) {
    ...
    $catebus = $controller->buscarPerfilCatequista($ciPersona);
} else {
    header("Location: VistaCatequista.php");
    exit();
}
        ...
        <div class="container">
            <div class="row g-4">
                <div class="col-lg-8 vstack gap-4">
                    <div class="card">
                        <div class="h-200px rounded-top" style="background-image:url(<?php echo ($catebus['FondoCat'] == 'Ninguno' || empty($catebus['FondoCat'])) ? '../assets/images/fondo/Ninguno.jpg' : "../assets/images/fondo/{$catebus['FondoCat']}"; ?>); background-position: center; background-size: cover; background-repeat: no-repeat;"></div>

                        <div class="card-body py-0">
                            <div class="d-sm-flex align-items-start text-center text-sm-start">
                                <div>
                                    <div class="avatar avatar-xxl mt-n5 mb-3">
                                        <img class="avatar-img rounded-circle border border-white border-3" src="<?php echo ($catebus['ImagenCat'] == 'Ninguno' || empty($catebus['ImagenCat'])) ? '../assets/images/avatar/Ninguno.png' : "../assets/images/avatar/{$catebus['ImagenCat']}"; ?>" alt="">
                                    </div>
                                </div>
                                <div class="ms-sm-4 mt-sm-3">
                                    <h1 class="mb-0 h5"><?php echo $catebus['NombreCompleto']; ?> <?php if ($catebus['RolCat'] == "Coordinador" || $catebus['RolCat'] == "Titular") : ?><i class="bi bi-patch-check-fill text-success small"></i><?php endif; ?></h1>
                                    <p>Catequista "<strong>San Pedro de Sacaba</strong>"</p>
                                </div>

                            </div>
                            <ul class="list-inline mb-0 text-center text-sm-start mt-3 mt-sm-0">
                                <li class="list-inline-item"><i class="bi bi-briefcase me-1"></i> Cargo <strong><?php echo $catebus['RolCat']; ?></strong></li>
                                <li class="list-inline-item"><i class="bi bi-geo-alt me-1"></i>Sacaba - Chapare</li>
                                <li class="list-inline-item"><i class="bi bi-person-rolodex me-1"></i> Catequista de <strong><?php echo $catebus['Sacramento']; ?></strong></li>
                                <li class="list-inline-item"><i class="<bi bi-collection me-1"></i> Grupo: <strong><?php echo $catebus['NombreGrupo']; ?></strong></li>
                            </ul>
                        </div><br>
                    </div>
                    ...
                    <div class="card card-body">
                        ...
                        <?php if ($catebus['EstadoCat'] == "Activo") : ?>

                            <div class="card-header border-0 pb-0">
                                <h5 class="card-title">Información de Cuenta</h5>
                            </div>
                            <div class="card-body position-relative pt-0">
                                <p><?php echo $catebus['FraseCat']; ?></p>
                                <ul class="list-unstyled mt-3 mb-0">
                                    <?php
                                    $fechaAdm = $catebus['FechaIniCat'];
                                    ...
                                    $fechaAdmNac = $catebus['FechaNac'];
                                    $timestampFechaNac = strtotime($fechaAdmNac);
                                    $diaNac = date('d', $timestampFechaNac);
                                    $mesNac = $meses[date('n', $timestampFechaNac) - 1];
                                    $fechaFormateadaNac = "$diaNac de $mesNac";
                                    ?>
                                    <li class="mb-2"> <i class="bi bi-calendar2-plus me-1"></i> Ingresó: <?php echo $fechaFormateada; ?></li>

                                    <li class="mb-2"> <i class="bi bi-cake2-fill me-1"></i> Cumpleaños: <strong> <?php echo $fechaFormateadaNac; ?></strong></li>

                                    <li class="mb-2" <?php if ($catebus['EstadoCat'] == "Activo") : ?>style="color:limegreen;" <?php elseif ($catebus['EstadoCat'] == "Inactivo") : ?>style="color:Red;" <?php endif; ?>> <i class="bi bi-broadcast"></i> Estado: <strong> <?php echo $catebus['EstadoCat']; ?> </strong> </li>

                                    <li> <i class="bi bi-telephone fa-fw pe-1"></i> Contacto: <strong> <?php echo $catebus['Contacto']; ?> </strong> </li>
                                </ul>
                            </div>
                            <a class="btn btn-success-soft btn-sm" href="PerfilCatequista.php">Volver a mi Perfil</a>

                        <?php elseif ($catebus['EstadoCat'] == "Inactivo") : ?>
                            <div class="col-lg-8 mx-auto align-items-center text-center justify-content-sm-between">
                                ...
                                <a class="btn btn-danger-soft btn-sm" href="PerfilCatequista.php">Volver a mi Perfil</a>
                            </div>
                        <?php endif; ?>
