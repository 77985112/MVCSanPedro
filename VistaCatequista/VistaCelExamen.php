...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['idCelEx']) && isset($_POST['numNota']) && isset($_POST['nota']) && isset($_POST['CodExamen'])) {
    $idCelEx = $_POST['idCelEx'];
    $numNota = $_POST['numNota'];
    $nota = $_POST['nota'];
    $codExamen = $_POST['CodExamen'];

    if ($contNota->asignarNota($idCelEx, $numNota, $nota)) {
...
$examenes = $contNota->listarExamenes();
        ...
        <div class="container">
            <div class="row g-4">
                                ...
                                <div class="card overflow-hidden">
                                    ...
                                    <div class="card-body pt-0">
                                        ...
                                        <ul class="nav nav-link-secondary flex-column fw-bold gap-2">
                                            ...
                                            <?php if ($Catequista['RolCat'] == "Titular") { ?>
                                                <li class="nav-item">
                                                    <a class="nav-link active" href="VistaCelExamen.php"> <img class="me-2 h-20px fa-fw" src="../assets/images/icon/Examen.png" alt=""><span>Pruebas</span></a>
                                                </li>
                                                <li class="nav-item">
                ...
                <div class="col-md-8 col-lg-6 vstack gap-4">
                    <div class="card p-3">
                        <h4>Prueba de Conocimientos </h4>
                        <p>Lo mismo que un árbol tiene una sola raíz y múltiples ramas y hojas, también hay un solo Dios, pero diversificada en numerosas ramas por intervención de los hombres.</p>
                            ...
                            <div class="card card-body mt-1">
                                ...
                                <form action="" method="POST" class="row g-3">
                                    <div class="col-sm-6 col-lg-4 form-group">
                                        ...
                                        <select name="CodExamen" class="form-control" required>
                                            <option value="">Seleccionar Examen</option>
                                            <?php foreach ($examenes as $examen): ?>
                                                <option value="<?php echo $examen['CodExamen']; ?>">
                                                    <?php echo $examen['TituloExamen']; ?> - <?php echo $examen['FechaExamen']; ?>
                                                </option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-sm-2 col-lg-2 form-group">
                                        <label class="form-label">Catequisando</label>
                                        <input type="number" class="form-control" name="idCelEx" value="0" required>
                                    </div>

                                    <div class="col-sm-3 col-lg-3 form-group">
                                        <label class="form-label">Número de Nota (1-4)</label>
                                        <input type="number" class="form-control" name="numNota" min="1" max="4" value="0" required>
                                    </div>

                                    <div class="col-sm-3 col-lg-3 form-group">
                                        <label class="form-label">Asignar Nota (1-100)</label>
                                        <input type="number" class="form-control" name="nota" min="0" max="100" value="0" required>
                                    </div>

                                    <div class="col-lg-12 align-items-center d-flex py-3">
                                        <div class="col-sm-6 col-lg-6 me-2">
                                            <button type="submit" class="btn btn-success-soft w-100">Asignar o Modificar Nota</button>
                                        </div>
                                        <div class="col-sm-6 col-lg-6">
                                            <a href="generar_Nota.php" target="_blank" class="btn btn-primary-soft w-100">Generar Reporte de Notas</a>
                                        </div>
                                    </div>
                                ...
                                <br>
                                <h6>Detalle de examenes realizados</h6>
                                <table class="table">
                                    ...
                                    <tbody>
                                        <?php foreach ($celebrantes as $celebrante): ?>
                                            <tr>
                                                <td><?php echo $celebrante['IdCelEx']; ?></td>
                                                <td><?php echo $celebrante['Nombre'] . ' ' . $celebrante['ApPaterno'] . ' ' . $celebrante['ApMaterno']; ?></td>
                                                <td><?php echo $celebrante['NotaExamen1']; ?></td>
                                                <td><?php echo $celebrante['NotaExamen2']; ?></td>
                                                <td><?php echo $celebrante['NotaExamen3']; ?></td>
                                                <td><?php echo $celebrante['NotaExamen4']; ?></td>
                                                <td><?php echo round($celebrante['Promedio']); ?></td>
                                            </tr>
                                        <?php endforeach; ?>
                                    </tbody>
                                </table>
