...
$catequistas = $catequistaModel->obtenerCatequistasDelGrupo($CatGr, $CatCi);
            ...
            <div class="row g-4">
                <div class="col-lg-8 vstack gap-4">
                        ...
                        <div class="card-body py-0">
                            <div class="d-sm-flex align-items-start text-center text-sm-start">
                                ...
                                <div class="ms-sm-4 mt-sm-3">
                                    <h1 class="mb-0 h5"><?php echo $Catequista['Nombre'] . " " . $Catequista['ApPaterno'] . " " . $Catequista['ApMaterno']; ?> <?php if ($Catequista['RolCat'] == "Coordinador" || $Catequista['RolCat'] == "Titular") : ?><i class="bi bi-patch-check-fill text-success small"></i><?php endif; ?></h1>
                                    <p>Catequista "<strong>San Pedro de Sacaba</strong>"</p>
                                </div>

                            </div>
                            <ul class="list-inline mb-0 text-center text-sm-start mt-3 mt-sm-0">
                                <li class="list-inline-item"><i class="bi bi-briefcase me-1"></i> Cargo <strong><?php echo $Catequista['RolCat']; ?></strong></li>
                    ...
                    <div class="card card-body">
                        ...
                        <?php if ($Catequista['EstadoCat'] == "Activo") : ?>

                        <?php elseif ($Catequista['EstadoCat'] == "Inactivo") : ?>
                        ...
                        <div class="col-md-6 col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-body position-relative pt-0">
                                    <p><?php echo $Catequista['FraseCat']; ?></p>
                                    <ul class="list-unstyled mt-3 mb-0">
                                        <?php
                                        $fechaAdm = $Catequista['FechaIniCat'];
                                        ...
                                        <li class="mb-2" <?php if ($Catequista['EstadoCat'] == "Activo") : ?>style="color:limegreen;" <?php elseif ($Catequista['EstadoCat'] == "Inactivo") : ?>style="color:Red;" <?php endif; ?>> <i class="bi bi-broadcast"></i> Estado: <strong> <?php echo $Catequista['EstadoCat']; ?> </strong> </li>

                                        <li> <i class="bi bi-telephone fa-fw pe-1"></i> Contacto: <strong> <?php echo $Catequista['Contacto']; ?> </strong> </li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                                                ...
                                                <div class="col-6">
                                                    <div class="card shadow-none text-center h-100">
                                                        ...
                                                        <div class="card-footer p-2 border-0">
                                                            <a href="PerfilAjenoCat.php?IpCS=<?php echo htmlspecialchars($cates['CiCat']); ?>"><button class="btn btn-sm btn-primary" data-bs-toggle="tooltip" data-bs-placement="top" title="Ver Perfil"> <i class="bi bi-eye-fill"></i>
                                                            </button></a>
                                                            <?php if ($Catequista['RolCat'] == "Titular" && $Catequista['EstadoCat'] == "Activo") : ?>
                                                                <button class="btn btn-sm btn-danger" data-bs-toggle="tooltip" data-bs-placement="top" title="Asignar Tarea">
