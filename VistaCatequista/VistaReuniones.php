...
$modelo = new AsistenciaApoderadoModel($db);
$controlador = new AsistenciaApoderadoController($modelo);
                                    ...
                                    <div class="card-body pt-0">
                                        ...
                                        <ul class="nav nav-link-secondary flex-column fw-bold gap-2">
                                            ...
                                            <?php if ($Catequista['RolCat'] == "Titular") { ?>
                                                <li class="nav-item">
                                                    <a class="nav-link active" href="VistaReuniones.php"> <img class="me-2 h-20px fa-fw" src="../assets/images/icon/instrucciones.png" alt=""><span>Reuniones / Actividades</span></a>
                                                </li>
                                            <?php } ?>
                                            <li class="nav-item">
                    ...
                    <div class="card h-100">
                            ...
                            <div class="py-3">
                                <div class="row position-relative">
                                    <div class="col-lg-10 mx-auto">
                                        <div class="text-center">
                                            <h1>Toma de Asistencia (Reuniones)</h1>
                                            <p>Selecciona una fecha para relizar la toma de asistencia</p>
                                        </div>
                                        <div class="mx-auto bg-mode shadow rounded p-4 mt-5 col-lg-6">
                                            ...
                                            <br>
											<form action="ReuAct_pdf.php" method="post">
												...
												<button type="submit" class="btn btn-primary-soft w-100" target="_blank" data-bs-toggle="tooltip" data-bs-placement="top" title="PDF de Reunión y Actividades">
                        ...
                        <div class="p-3">
                            ...
                            <?php if (isset($_POST['fecha'])): ?>
                                <?php
                                $idReunion = $controlador->obtenerIdReunionPorFechaYGrupo($_POST['fecha']);

                                if (!$idReunion): ?>
                                    <h3>No hay reunión para la fecha seleccionada.</h3>
                                <?php else: ?>
                                    <?php $asistencias = $controlador->obtenerAsistenciaPorFechaYGrupo($_POST['fecha'], $idGrupo); ?>
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php foreach ($celebrantes as $celebrante): ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input type="hidden" name="DetalleAsis[<?= $celebrante['IdInscripcion'] ?>]" value="Falta">
                                                                <input type="checkbox" name="DetalleAsis[<?= $celebrante['IdInscripcion'] ?>]" value="Presente" onchange="this.previousElementSibling.value = this.checked ? 'Presente' : 'Falta';"> Presente
                                                                <input type="hidden" name="IdInscripcion[]" value="<?= $celebrante['IdInscripcion'] ?>">
                                                            </td>
                                                            <td>
                                                                <input type="number" name="MontoAsis[<?= $celebrante['IdInscripcion'] ?>]" value="0">
                                                            </td>
                                                        </tr>
                                                    <?php endforeach; ?>
                                                </tbody>
                                            </table>
                                            <button type="submit" name="registrar" class="btn btn-success-soft w-100">Registrar</button>
                                        </form>
                                    <?php else: ?>
                                        <h2>Modificar Asistencia por Fecha</h2>
                                        <form method="post">
                                            <input type="hidden" name="IdReunion" value="<?= $idReunion ?>">
                                            <table class="table">
                                                <thead class="table-dark">
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php foreach ($asistencias as $asistencia): ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input type="hidden" name="DetalleAsis[<?= $asistencia['IdInscripcion'] ?>]" value="Falta">
                                                                <input type="checkbox" name="DetalleAsis[<?= $asistencia['IdInscripcion'] ?>]" value="Presente" <?= strpos($asistencia['DetalleAsis'], 'Presente') !== false ? 'checked' : '' ?> onchange="this.previousElementSibling.value = this.checked ? 'Presente' : 'Falta';"> Presente
                                                                <input type="hidden" name="IdInscripcion[]" value="<?= $asistencia['IdInscripcion'] ?>">
                                                            </td>
                                                            <td>
                                                                <input style="width: 50px;" type="number" name="MontoAsis[<?= $asistencia['IdInscripcion'] ?>]" value="<?= $asistencia['MontoAsis'] ?>">
                                                            </td>
                                                        </tr>
                                                    <?php endforeach; ?>
                                                </tbody>
                                            </table>
                                            <button type="submit" name="modificar" class="btn btn-primary-soft w-100">Modificar</button>
                                        </form>
