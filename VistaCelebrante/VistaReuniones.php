...
require_once '../controlador/controladorReunion.php';
$contReu = new AsistenciaApoderadoModel;
$ReunionAll = $contReu->obtenerReunion();
                ...
                <div class="col-lg-8 vstack gap-4">
                    ...
                    <div class="card card-body">
                        ...
                        <?php if ($Celebrante['EstadoCel'] == "Activo") : ?>
                            ...
                            <h3>Próximas reuniones registradas</h3>

                            <table class="table table-hover">
                                <thead class="table-dark">
                                    <tr>
                                        <th>Fecha de Reunión</th>
                                        <th>Hora de Reunión</th>
                                        <th>Detalle de Reunión</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php if (!empty($ReunionAll)) : ?>
                                        <?php foreach ($ReunionAll as $ReunionAllT) : ?>
                                            <tr>
                                                <td><?= htmlspecialchars($ReunionAllT['FechaReu']) ?></td>
                                                <td><?= htmlspecialchars($ReunionAllT['HoraReu']) ?></td>
                                                <td><?= htmlspecialchars($ReunionAllT['DetalleReu']) ?></td>
                                            </tr>
                                        <?php endforeach; ?>
                                    <?php else : ?>
                                        <tr>
                                            <td colspan="5">No se han registrado Reuniones aun.</td>
                                        </tr>
                                    <?php endif; ?>
                                </tbody>
                            </table>
