...
$modelo = new Modelo();
$catequistas = $modelo->obtenerCatequistasPorGrupo($IdGrupo);
$celebrantes = $modelo->obtenerCelebrantesPorGrupo($IdGrupo);

$colorGrupo = ($Celebrante['Color_Grupo'] === "Ninguno") ? "#000000" : $Celebrante['Color_Grupo'];
            ...
            <div class="container">
                <div class="row g-4">
                    <div class="col-12 vstack gap-4">
                        <div class="card p-3">
                            <h1 class="text-center p-2">Mis catequistas</h1>
                                                ...
                                                <div class="col-sm-6 col-lg-3">
                                                    <div class="card shadow-none text-center h-100">
                                                        <div class="card-body p-2 pb-0">
                                                            ...
                                                            <h6 class="card-title mb-1 mt-3"><a href="PerfilAjenoCat.php?IpCS=<?= htmlspecialchars($cates['CiCat']) ?>"><?php echo htmlspecialchars($cates['NombreCompleto']); ?></a></h6>
                            ...
                            <h2 class="text-center p-2">Mis compañeros</h2>
                            <div class="container d-flex" style="justify-content: center; align-items: center;">
                                <div class="col-lg-8">
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            <?php if (!empty($celebrantes)) : ?>
                                                <?php foreach ($celebrantes as $celebranteO) : ?>
                                                    <tr>
                                                        <td>
                                                            <div class="avatar align-middle">
                                                                <img class="avatar-img rounded-3" src="<?php echo ($celebranteO['PerfilCel'] == 'Ninguno' || empty($celebranteO['PerfilCel'])) ? '../assets/images/avatar/Ninguno.png' : "../assets/images/avatar/{$celebranteO['PerfilCel']}"; ?>" alt="avatar">
                                                            </div>
                                                        </td>
                                                        <td><strong><?= htmlspecialchars($celebranteO['NombreCompleto']) ?></strong><br><?= htmlspecialchars($celebranteO['DescripItem']) ?></td>
                                            ...
                                            <?php else : ?>
                                                <tr>
                                                    <td colspan="2">No hay catequisandos asignados a este grupo.</td>
                                                </tr>
                                            <?php endif; ?>
                                        </tbody>
                                    </table>
