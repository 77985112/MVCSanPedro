<?php
session_start();
require_once '../Controlador/controladorConfigPersonal.php';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['cambiarPerfil'])) {
        $usuarioController->cambiarImagen($usuario['CiPersonal'], 'PerfilPer', $_FILES['nuevaImagen']);
        header("Refresh:1");

    } elseif (isset($_POST['cambiarFondo'])) {
        $usuarioController->cambiarImagen($usuario['CiPersonal'], 'FondoPer', $_FILES['nuevaImagen']);
        header("Refresh:1");
    }
}

if (isset($_POST['cambiarFrase'])) {
    $usuarioController->cambiarFrase($usuario['CiPersonal'], $_POST['frase']);
    header("Refresh:1");
}

if (isset($_POST['cambiarContacto'])) {
    $usuarioController->cambiarContacto($usuario['CiPersonal'], $_POST['Contactodato']);
    $_SESSION['usuario']['ContactoPer'] = $_POST['Contactodato'];
    header("Refresh:1");
}

if (isset($_POST['cambiarContracat'])) {
    $usuarioController->cambiarContrasena($usuario['CiPersonal'], $_POST['ActualC'], $_POST['NuevoC1'], $_POST['NuevoC2'], $usuario['ClavePer']);
}

if (isset($_POST['EliminarCount'])) {
    $usuarioController->eliminarCuenta($usuario['CiPersonal']);
    header("Location: ../logout.php");
    exit();
}
?>
                            ...
                            <div class="offcanvas-body p-0">
                                <div class="card w-100">
                                    ...
                                    <div class="card-footer text-center py-2">
                                        <a class="btn btn-link text-secondary btn-sm" href="PerfilAdmin.php">Volver al perfil</a>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-lg-6 vstack gap-4">
                    <div class="tab-content py-0 mb-0">
                                ...
                                <div class="card-body">
                                        ...
                                        <ul class="list-group">
                                            <li class="list-group-item d-md-flex justify-content-between align-items-center">
                                                <div class="me-md-3">
                                                    ...
                                                    <img id="imagenPreviewPerfil" class="avatar-img rounded-circle border border-white border-3" src="<?php echo ($usuario['PerfilPer'] == 'Ninguno' || empty($usuario['PerfilPer'])) ? '../assets/images/avatar/Ninguno.png' : "../assets/images/avatar/{$usuario['PerfilPer']}"; ?>" alt="" style="width: 200px; height: 200px;">
                                                    <p class="small mb-0" id="imagenTextoPerfil"><?php echo ($usuario['PerfilPer'] == 'Ninguno' || empty($usuario['PerfilPer'])) ? 'Fondo Genérico' : 'Perfil Actual'; ?></p>
                                                </div>
                                                <div class="me-md-3">
                                                    <h6 class="mb-0">Imagen de Fondo</h6>
                                                    <img id="imagenPreviewFondo" class="h-200px rounded" src="<?php echo ($usuario['FondoPer'] == 'Ninguno' || empty($usuario['FondoPer'])) ? '../assets/images/fondo/Ninguno.jpg' : "../assets/images/fondo/{$usuario['FondoPer']}"; ?>" alt="" style="background-size: cover; background-repeat: no-repeat; width: 450px; height: 200px;">
                                                    <p class="small mb-0" id="imagenTextoFondo"><?php echo ($usuario['FondoPer'] == 'Ninguno' || empty($usuario['FondoPer'])) ? 'Fondo Genérico' : 'Fondo Actual'; ?></p>
                                                </div>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="rounded border px-3 py-2 mb-3">
                                        <form action="" method="post">
                                            ...
                                            <textarea type="text" name="Frase" class="form-control"><?php echo $usuario['FrasePer']; ?></textarea>
                                        </form>
                                    </div>
                                    ...
                                    <div class="row g-4">
                                        <div class="col-sm-6">
                                            <div class="d-flex align-items-center rounded border px-3 py-2">
                                                <p class="mb-0">
                                                    <i class="bi bi-person fa-fw me-2"></i> Nombre: <strong> <?php echo $usuario['Nombre'] . " " . $usuario['Paterno'] . " " . $usuario['Materno']; ?></strong>
                                                </p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="d-flex align-items-center rounded border px-3 py-2">
                                                <p class="mb-0">
                                                    <i class="bi bi-briefcase fa-fw me-2"></i> Rol: <strong> <?php echo $usuario['DescripCar']; ?></strong>
                                                </p>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <form action="" method="post">
                                                <div class="d-flex align-items-center rounded border px-3 py-2">
                                                    ...
                                                    </p> <input type="text" id="Contactodato" name="Contactodato" class="form-control" style="font-size: 12pt; height: 20px; width:150px; " value="<?php echo $usuario['ContactoPer']; ?>"></input>
                        ...
                        <div class="tab-pane fade" id="nav-setting-tab-4">
                            <form action="" method="post">
                                <input type="hidden" value="<?php echo $usuario['CiPersonal']; ?>" name="ciPersonal">
                                <div class="card">
                                    <div class="card-header border-0 pb-0">
                                    ...
                                    <div class="card-body">
                                        <h6>Antes de irte...</h6>
                                        <ul>
                                            <li>Puedes ver tu información <a href="PerfilAdmin.php">aquí</a> </li>
                                        ...
                                        <a href="PerfilAdmin.php" class="btn btn-success-soft btn-sm mb-2 mb-sm-0">Cancelar Eliminación</a>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.EstadoCat && response.RolCat) {
                            ...
                            if (response.RolCat === "usuario" || response.RolCat === "Titular") {
